...
class ArticleController extends Controller
{
     ...
     * @Method("POST")
     * @Template("StephaneBlogBundle:Article:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('StephaneBlogBundle:Article')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("StephaneBlogBundle:Article:edit.html.twig")
     */
